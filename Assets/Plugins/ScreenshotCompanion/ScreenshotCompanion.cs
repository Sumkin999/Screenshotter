...
public class ScreenshotCompanion : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        if (Input.GetKeyDown(KeyCode.A))
        {
                    ...
                    {
                        Camera attachedCam = list[0].cam.GetComponent<Camera>();
                        if (attachedCam == null)
                        {
                            Debug.Log("CapScreenFIRSTCAM!");
                            CaptureScreenshots(0, true);
                        }
                        else
                        {
                            Debug.Log("CapScreenNOCAM!");
                            CaptureRenderTexture(attachedCam, 0);
                        }
                    }
                    ...
                    {
                        Debug.Log("CapCutout!");
                        StartCoroutine(CaptureCutout(0));
                    }
