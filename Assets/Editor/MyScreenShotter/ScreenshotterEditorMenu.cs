...
namespace Editor.MyScreenShotter
{
	...
	[ExecuteInEditMode]
    public class ScreenshotterEditorMenu: EditorWindow
{
	...
	[MenuItem("Tools/FEDOR/Instant High-Res Screenshot")]
	...
	{
		StartCoroutine(GetScreenshotMethod());
	}*/
	public IEnumerator GetScreenshotMethod()
	{
